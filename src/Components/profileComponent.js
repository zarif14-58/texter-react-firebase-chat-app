        ...
        return(
            <React.Fragment>
                <div className="container" style={{paddingTop: "50px"}}>
                    ...
                    {!this.state.edit && <div className="text-center escape">
                        <Button color="success" onClick={this.handleEdit}>Edit</Button>
                    </div>}
                    {this.state.edit && <div className="text-center escape">
                        <Button color="warning" onClick={this.handleEdit}>Cancel Editing</Button>
                    </div>}
                ...
                {!this.state.edit && <div className="container">
                    <Favorite />
                </div>}
            </React.Fragment>
        )
